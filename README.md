...
<img src="./client/src/assets/search_tool.png" alt="Airline policy search tool" style="width: 100%; border-radius: 8px; margin: 12px 0;">
...
<img src="./client/src/assets/famous_locations.png" alt="Pet-friendly destinations map" style="width: 100%; border-radius: 8px; margin: 12px 0;">
...
<img src="./client/src/assets/efficient_management.png" alt="Trip planning dashboard" style="width: 100%; border-radius: 8px; margin: 12px 0;">

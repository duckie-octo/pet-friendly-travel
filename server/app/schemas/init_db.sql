...
('Lan', 'Doan', 'huong.doan@sjsu.edu', '99-99-9999-9999'); --Added
...
('Travel Expert Alice', 'alice@travel.com', '555-555-5555'); -- Added
...
('Le Meurice', '228 Rue de Rivoli', 'Paris', '75001', 'France', 'reservations@meurice.com', 1, 80.00, 1),
('Hyatt Regency Embarcadero', '5 Embarcadero Center', 'San Francisco', '94111', 'USA', 'sf.regency@hyatt.com', 0, NULL, NULL),
('Shinjuku Pet-Friendly Inn', '2-14-13 Kabukicho', 'Tokyo', '160-0021', 'Japan', 'pets@shinjuku-inn.jp', 1, 20.00, 3);
...
('HND', 'Tokyo Haneda Airport', 'Tokyo', 'Japan'); -- Added
...
(3, NULL, '2024-06-01', '2024-06-05'); -- Returns Booking_Id 3
...
(3, 6, '2024-06-02', '14:00', '2024-06-05', 450.00); -- Booking 3 (Lan in Tokyo) staying at a hotel in Tokyo (Hotel_Code 6).
...
(3, 'BA', '113', '2024-06-21', '10:15', '2024-06-21', '13:10', 850.00, 'LHR', 'JFK'); -- Added Booking 3 (Lan Tokyo to Paris). Round trip.

-- Booking 2 (Jane NY to LA). One way Delta flight.
INSERT INTO Flight_Reservations (Booking_Id, Airline_Code, Flight_Number, Departure_Date, Departure_Time, Arrive_Date, Arrive_Time, Rate, Origin_Airport_Code, Destination_Airport_Code) VALUES
(2, 'DL', '45', '2024-08-15', '07:00', '2024-08-15', '10:05', 315.50, 'JFK', 'LAX');

-- Booking 3 (Lan in Tokyo) booked a one-way Delta flight.
INSERT INTO Flight_Reservations (Booking_Id, Airline_Code, Flight_Number, Departure_Date, Departure_Time, Arrive_Date, Arrive_Time, Rate, Origin_Airport_Code, Destination_Airport_Code) VALUES
(3, 'DL', '45', '2024-06-04', '07:00', '2024-06-04', '10:05', 315.50, 'HND', 'CDG');
...
-- Booking 3 (Lan in Tokyo) booked a city tour.
INSERT INTO Activity_Reservations (Booking_Id, Activity_Name, Location, Activity_Date, Price) VALUES
(3, 'Tokyo City Sightseeing Tour', 'Tokyo', '2024-06-04', 120.00);
-- =========================================================================
